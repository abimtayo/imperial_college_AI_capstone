...
2. kappa: acquisition function parameter for Upper Confidence Bound (UCB)
3. nu: smoothness parameter for Matern surrogate optimisation.
4. length_scale_lower: lower length scale bound for Guassian Process surrogate optimisation
5. length_scale_upper: upper length scale bound for Guassian Process surrogate opotimisation
6. noise_level: initial noise level for Guassian Process surrogate optimisation
7. noise_level_lower: lower noise level bound for Guassian Process surrogate optimisation
8. noise_level_upper: upper noise level bound for Guassian Process surrogate optimisation
